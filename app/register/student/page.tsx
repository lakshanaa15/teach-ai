          ...
          <Card className="border-border shadow-xl">
            <CardHeader className="space-y-2 border-b border-border/60 pb-5 bg-muted/20">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <CardTitle className="text-xl font-bold">Register as Student</CardTitle>
                  <p className="text-xs text-muted-foreground">
                    Join M. Kumarasamy College of Engineering (MKCE) on TeachAI
                  </p>
                </div>
              </div>
            </CardHeader>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                >
                  {isLoading ? 'Creating Student Account…' : 'Register Student Account'}
              ...
              <div className="border-t border-border pt-4 text-center space-y-2 text-xs text-muted-foreground">
                ...
                <p>
                  Are you an educator?{' '}
                  <Link href="/register/teacher" className="font-semibold text-foreground hover:underline">
                    Register as Teacher
                  </Link>
                </p>
              </div>
